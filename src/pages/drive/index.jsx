...
function DriveRoute() {
  ...
  const uploadFile = async (file, path) => {
    ...
    axios
      .post(
        "https://cors-nap.herokuapp.com/https://catbox.moe/user/api.php",
        formData,
        {
  ...
  return (
    <>
      ...
      {filesUploading.length > 0 && (
        <div className="upload-progress-box">
          <div className="upload-progress-header">
            ...
            {filesUploading.every((e) => e.percentage === 100) && (
              <CloseBtn setFilesUploading={setFilesUploading} />
            )}
          </div>
      ...
      <Switch>
        ...
        <Route
          path={`${path}/folder/:id`}
          children={<Folders uploadFile={uploadFile} />}
        ></Route>
        <Route path={`${path}/*`}>
          <NotFound />
        </Route>
