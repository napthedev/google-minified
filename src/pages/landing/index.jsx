    ...
    <>
      ...
      <div className="footer">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <a href="https://facebook.com/napthedev" target="_blank" rel="noreferrer">
            <Facebook style={{ height: 30, width: 30 }} className="svg-fill" />
          </a>
          <a href="https://github.com/napthedev" target="_blank" rel="noreferrer">
            <GitHub style={{ height: 26, width: 26 }} className="svg-fill" />
          </a>
          <a href="https://discordapp.com/users/877882975855992852" target="_blank" rel="noreferrer">
